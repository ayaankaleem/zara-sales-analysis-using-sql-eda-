...
This notebook analyzes a retail clothing dataset to understand what factors affect how well products sell. It looks at things like store placement, promotions, pricing, and seasons to find patterns in sales.
---
About the Dataset
The dataset contains information about clothing products from a retail store. Each product has details like:
Where it was placed in the store (aisle, end-cap, or front of store)
Whether it was on promotion or not
Which season it was sold in
Its price
